...
| [運用](./operation/index.md) | 環境構築、デプロイ、運用手順の整理 | 4 件の運用ドキュメントを配置 |
...
- `operation/` には現在 4 件の運用ドキュメントを配置（`local_setup.md` / `heroku_staging_setup.md` / `heroku_production_setup.md` / `deploy.md`）。
